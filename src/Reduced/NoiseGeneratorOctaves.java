...
public class NoiseGeneratorOctaves {
  ...
  public NoiseGeneratorOctaves(Random var1, int var2) {
    ...
    this.field_1192_a = new NoiseGeneratorPerlin[var2];

    for (int var3 = 0; var3 < var2; ++var3) {
      this.field_1192_a[var3] = new NoiseGeneratorPerlin(var1);
    }
  ...
  public double[] func_807_a(double[] var1, double var2, double var4, double var6, int var8, int var9, int var10,
    ...
    for (int var19 = 0; var19 < this.field_1191_b; ++var19) {
      this.field_1192_a[var19].func_805_a(var1, var2, var4, var6, var8, var9, var10, var11 * var20, var13 * var20,
          var15 * var20, var20);
      var20 /= 2.0D;
    }
